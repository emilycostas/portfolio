    ...
    <section className="about">
      ...
      <div className="about-grid">
        <div className="about-text">
          ...
          <p>Jeg har vært innom alle Adobe-programmene gjennom fag, men bruker hovedsaklig Figma mest i skole- og i egne prosjekter. 
             I prosjekter er jeg opptatt av god kommunikasjon og fremdrift med de jeg jobber med, og har i studiet ofte tatt på meg en lederrolle i gruppene jeg har vært i. Jeg liker å jobbe strukturert, 
             men samtidig kreativt. I denne porteføljen finnes en del av prosjektene jeg har jobbet med i skolesammenheng og individuelt. I alle prosjekter lagt ved har det vært hovedsakelig jeg som har jobbet med det visuelle.
